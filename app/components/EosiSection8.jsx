        ...
        <div className="flex flex-col w-full space-y-4 pt-32">
            ...
            <div className="pl-28">
                <div className="border-2 rounded-lg border-yellow-400 px-6 py-6">
                    ...
                    <img className="py-3" src="section8-image1.png" alt="" />
            ...
            <div className="pr-24">
                <div className="border-2 rounded-lg border-yellow-400 px-10 py-6">
                    ...
                    <img className="py-3" src="section8-image2.png" alt="" />
            ...
            <div className="pl-28  ">
                <div className="border-2 rounded-lg border-yellow-400 px-6 py-6">
                    ...
                    <img className="py-3" src="section8-image3.png" alt="" />
